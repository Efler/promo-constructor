...
@router.get("")
def list_promocodes(current_seller: SellerIdentity = Depends(get_current_seller)) -> dict[str, object]:
    return {
        "items": [],
        "seller": current_seller.username,
        "message": "Promocodes module scaffold is ready for future mechanics.",
    }
