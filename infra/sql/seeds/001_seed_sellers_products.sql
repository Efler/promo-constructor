...
values
    ...
    (
        ...
        'Северный берег',
        'Легкая бутылка для воды с удобной крышкой и матовым покрытием.',
        203,
        'Бутылки',
        20,
        'Товары для дома',
    ...
    (
        ...
        'Флисовый плед',
        'Домашний уют',
        'Мягкий флисовый плед для дома, отдыха и уютных сезонных подборок.',
        204,
        'Пледы',
        20,
        'Товары для дома',
    ...
    (
        ...
        'Домашний уют',
        'Компактный органайзер для хранения канцелярии и мелочей на рабочем столе.',
        205,
        'Органайзеры',
        20,
        'Товары для дома',
    ...
    (
        ...
        'Ароматическая свеча',
        'Домашний уют',
        'Интерьерная ароматическая свеча в стеклянной банке для домашней атмосферы.',
        206,
        'Свечи',
        20,
        'Товары для дома',
...
values
    ...
    (
        (select p.id from products p join sellers s on s.id = p.seller_id where s.username = 'seller_roman' and p.vendor_code = 'ROM-BOTTLE-003'),
        503001,
        'ONE SIZE',
        '4607001000031',
        890.00,
    ...
    (
        (select p.id from products p join sellers s on s.id = p.seller_id where s.username = 'seller_roman' and p.vendor_code = 'ROM-PLAID-004'),
        504001,
        'ONE SIZE',
        '4607001000041',
        1990.00,
    ...
    (
        (select p.id from products p join sellers s on s.id = p.seller_id where s.username = 'seller_roman' and p.vendor_code = 'ROM-ORG-005'),
        505001,
        'ONE SIZE',
        '4607001000051',
        990.00,
    ...
    (
        (select p.id from products p join sellers s on s.id = p.seller_id where s.username = 'seller_roman' and p.vendor_code = 'ROM-CANDLE-006'),
        506001,
        'ONE SIZE',
        '4607001000061',
        790.00,
