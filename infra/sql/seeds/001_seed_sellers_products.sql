...
values
    (
        ...
        'North River',
        'Classic unisex cotton t-shirt for everyday marketplace assortment.',
        101,
        'T-Shirts',
        10,
        'Clothing',
    ...
    (
        ...
        'Ceramic Coffee Mug',
        'Home Peak',
        'White ceramic mug with minimalist print for kitchen and office use.',
        202,
        'Mugs',
        20,
        'Home Goods',
    ...
    (
        ...
        810000201,
        'ALI-HOODIE-001',
        'Oversize Fleece Hoodie',
        'Urban Nest',
        'Warm oversize hoodie designed for autumn and winter collections.',
        103,
        'Hoodies',
        10,
        'Clothing',
    ...
    (
        ...
        'Canvas Tote Bag',
        'Urban Nest',
        'Reusable canvas tote bag with reinforced handles.',
        301,
        'Bags',
        30,
        'Accessories',
    ...
    (
        ...
        'Desk LED Lamp',
        'Bright Form',
        'Compact LED desk lamp with adjustable angle and warm light mode.',
        401,
        'Table Lamps',
        40,
        'Lighting',
